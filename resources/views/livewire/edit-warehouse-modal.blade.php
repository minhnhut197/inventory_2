...
<div wire:ignore.self class="modal fade" id="editwarehouse" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="">
    <div class="modal-dialog">
        <div class="modal-content" style="width: 850px;height:375px">
            <div class="modal-header">
                <h4 class="modal-title"><b>Thay đổi thông tin nhà kho</b></h4>
