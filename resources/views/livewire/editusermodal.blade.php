    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width: 850px;height:485px">
            <div class="modal-header">
                <h4 class="modal-title"><b>Thay đổi thông tin người dùng</b></h4>
            ...
            <form action="" wire:submit.prevent="update">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group d-flex align-items-center justify-content-center pull-left">
                            <label for="" class="col-md-4 control-label">Mật khẩu</label>
                            <div class="col-md-6">
                                <input type="password" name="password" placeholder="Nhập mật khẩu"
                                    class="form-control input-md input-custom" wire:model.live="password">
                                @error('password')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group d-flex align-items-center justify-content-center pull-left">
                            <label for="" class="col-md-4 control-label">Vai trò</label>
                            <div class="col-md-6">
                                <select name="" id="" class="form-control input-custom"
