                ...
                <div class="col-md-82">
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <a href="{{route('admin.addgoodsreceipt2')}}">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($goodsreceipts as $goodsreceipt)
                                        <tr>
                                            ...
                                            <td>{{ $goodsreceipt->getCreator($goodsreceipt->creator) }}</td>
                                            <td>{{ $goodsreceipt->getSupplier($goodsreceipt->supplier) }}</td>
                                            <td>
                                                {{-- {{ $goodsreceipt->getItemName($goodsreceipt->item) }} --}}
                                            </td>
                                            <td>
                                                {{-- @if ($user->role == 0)
                                                    <span>Admin</span>
